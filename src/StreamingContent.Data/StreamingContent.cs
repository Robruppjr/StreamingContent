...
//* "Abstraction"
//* This is key for implementation of the Repository Pattern
public class StreamingContent
{
    //* We need some we properties
...
public bool IsFamilyFriendly 
    ...
    //* Full Constructor
    public StreamingContent(string title, string desctiption, double starRating, MaturityRating maturityRating, 
